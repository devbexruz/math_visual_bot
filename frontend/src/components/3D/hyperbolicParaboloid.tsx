...
export interface HyperbolicParaboloidProps {
  id: string;
  a: number;
  b: number;
  size: number;
...
// Giperbolik paraboloid (Egar): z = x²/a² - y²/b²
export const HyperbolicParaboloid: React.FC<HyperbolicParaboloidProps> = ({ a, b, size, color }) => {
