...
export const Footer: React.FC = () => {
  return (
        <footer style={{
            borderTop: '1px solid #1a1a1a', padding: '40px 20px', textAlign: 'center'
          }}>
            <div style={{ display: 'flex', justifyContent: 'center', gap: '20px', marginBottom: '20px', flexWrap: 'wrap' }}>
              
            <p style={{ margin: 0, color: '#444', fontSize: '0.9em' }}>
              <span style={{ color: '#666' }}>Boynazarov Bexruz</span> — Python Engineer
            </p>
              <a href="https://github.com/devbexruz" target="_blank" rel="noopener noreferrer"
                style={{ color: '#888', textDecoration: 'none', fontSize: '0.9em', display: 'flex', alignItems: 'center', gap: '6px', transition: '0.2s' }}
              ...
              <a href="https://instagram.com/bexruzdeveloper" target="_blank" rel="noopener noreferrer"
                style={{ color: '#888', textDecoration: 'none', fontSize: '0.9em', display: 'flex', alignItems: 'center', gap: '6px', transition: '0.2s' }}
              ...
              <a href="https://leetcode.com/bexruzdeveloper" target="_blank" rel="noopener noreferrer"
                style={{ color: '#888', textDecoration: 'none', fontSize: '0.9em', display: 'flex', alignItems: 'center', gap: '6px', transition: '0.2s' }}
            ...
            <p style={{ margin: '0 0 6px', color: '#555', fontSize: '0.85em' }}>
              © {new Date().getFullYear()} Math Visual AI
            </p>
    </footer>
  );
}